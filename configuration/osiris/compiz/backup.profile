...
[expo]
as_expo_key = <Super>e
as_expo_button = Button2
as_expo_edge = TopLeft
as_double_click_time = 497
...
as_directory = /home/osiris/Pictures/Screenshots
as_launch_app = scrot
...
[core]
as_active_plugins = core;session;decoration;titleinfo;png;screenshot;resize;regex;animation;blur;fade;move;grid;snap;place;workarounds;staticswitcher;
...
s0_focus_blur_match = (toolbar | menu | utility | normal | dialog | modaldialog) | title=Terminal
s0_focus_blur = false
s0_alpha_blur_match = any
s0_alpha_blur = true
s0_filter = 2
s0_gaussian_radius = 15
s0_gaussian_strength = 0.000000
s0_mipmap_lod = 5.700000
s0_saturation = 100
s0_occlusion = true
...
s0_force_placement_match = (all) | title=Application Finder
s0_position_matches = 
