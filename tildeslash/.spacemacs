...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(writeroom-mode centered-cursor-mode visual-fill-column pacmacs impatient-mode js2-mode rjsx-mode css-mode)
